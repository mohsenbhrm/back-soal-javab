...
// namespace SoalJavab.ServiceLayer
// {
...
//         {
//             return _identity.Value().GetUserId<long>();
//         }
...
//         {
//             return SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, ApplicationUser, long>(
...
//             this.RegisterTwoFactorProvider("PhoneCode", new PhoneNumberTokenProvider<ApplicationUser, long>
//             {
//                 MessageFormat = "Your security code is: {0}"
//             });
//             this.RegisterTwoFactorProvider("EmailCode", new EmailTokenProvider<ApplicationUser, long>
//             {
