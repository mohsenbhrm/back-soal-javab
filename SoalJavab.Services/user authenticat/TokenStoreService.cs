...
namespace SoalJavab.Services
{
    public interface ITokenStoreService
    {
        ...
        Task AddUserTokenAsync(ApplicationUser user, string refreshTokenSerial, string accessToken, string refreshTokenSourceSerial);
    ...
    public class TokenStoreService : ITokenStoreService
    {
        ...
        public async Task AddUserTokenAsync(ApplicationUser user, string refreshTokenSerial, string accessToken, string refreshTokenSourceSerial)
        {
